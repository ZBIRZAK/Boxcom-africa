...
const clientLogos = [
  { label: 'Samsung', src: `${process.env.PUBLIC_URL}/assets/Our%20Clients%20Logos/1.svg` },
  { label: 'AgriEdge', src: `${process.env.PUBLIC_URL}/assets/clients-pr/agriedge.png`, className: 'is-monochrome is-agriedge' },
  { label: 'Air France', src: `${process.env.PUBLIC_URL}/assets/Our%20Clients%20Logos/3.svg` },
  { label: 'Salon', src: `${process.env.PUBLIC_URL}/assets/clients-pr/salon.svg` },
  { label: 'Fever', src: `${process.env.PUBLIC_URL}/assets/clients-pr/fever.svg` },
  { label: 'DeFacto', src: `${process.env.PUBLIC_URL}/assets/clients-pr/defacto.svg` },
  { label: 'inDrive', src: `${process.env.PUBLIC_URL}/assets/clients-pr/indrive.svg` },
  { label: 'TotalEnergies', src: `${process.env.PUBLIC_URL}/assets/clients-pr/total.svg` },
  { label: 'Deloitte', src: `${process.env.PUBLIC_URL}/assets/clients-pr/deloitte.svg` },
  { label: 'Nouvelair', src: `${process.env.PUBLIC_URL}/assets/clients-pr/nouv.svg` },
  { label: 'DHL', src: `${process.env.PUBLIC_URL}/assets/clients-pr/dhl.svg` },
  { label: 'Netafim', src: `${process.env.PUBLIC_URL}/assets/clients-pr/netafim.svg` },
  { label: 'NTT DATA', src: `${process.env.PUBLIC_URL}/assets/clients-pr/ntt%20data.svg` },
  { label: 'GWM', src: `${process.env.PUBLIC_URL}/assets/clients-pr/gwm.svg` },
  { label: 'Garena', src: `${process.env.PUBLIC_URL}/assets/clients-pr/garena.svg` },
  { label: 'Yamaha', src: `${process.env.PUBLIC_URL}/assets/clients-pr/yamaha.svg` },
  { label: 'AXA', src: `${process.env.PUBLIC_URL}/assets/clients/axa.webp`, className: 'is-monochrome' },
  { label: 'AVEVA', src: `${process.env.PUBLIC_URL}/assets/clients-pr/aveva.svg` },
  { label: 'TVS', src: `${process.env.PUBLIC_URL}/assets/clients-pr/tvs.svg` },
  { label: 'Modanisa', src: `${process.env.PUBLIC_URL}/assets/clients-pr/modanisa.svg` },
  { label: 'DiliTrust', src: `${process.env.PUBLIC_URL}/assets/clients-pr/dilitrust.svg` },
  { label: 'Eqdom', src: `${process.env.PUBLIC_URL}/assets/clients-pr/eqdom.svg` },
  { label: 'Garden Expo', src: `${process.env.PUBLIC_URL}/assets/clients-pr/garden%20expo.svg` },
  { label: 'Elm', src: `${process.env.PUBLIC_URL}/assets/clients-pr/elm.svg` },
];
