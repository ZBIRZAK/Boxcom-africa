...
export const frenchHomeTestimonials = [
  { brand: 'Xerox', logo: asset('/assets/Our%20Clients%20Logos/4.svg'), name: 'Nom du client à ajouter', role: 'Fonction et entreprise à ajouter', quote: 'Témoignage sur les relations médias ou la qualité de la couverture à ajouter.' },
  { brand: 'Air France', logo: asset('/assets/Our%20Clients%20Logos/3.svg'), name: 'Nom du client à ajouter', role: 'Fonction et entreprise à ajouter', quote: 'Témoignage sur la rapidité, l’accompagnement de crise ou la clarté du conseil à ajouter.' },
  { brand: 'Xerox', logo: asset('/assets/Our%20Clients%20Logos/4.svg'), name: 'Nom du client à ajouter', role: 'Fonction et entreprise à ajouter', quote: 'Témoignage sur le déploiement régional ou la compréhension du marché local à ajouter.' },
];
