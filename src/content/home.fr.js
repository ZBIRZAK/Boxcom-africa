...
export const frenchHomeTestimonials = [
  ...
  { brand: 'Modanisa', logo: asset('/assets/clients-pr/modanisa.svg'), name: 'Ahmed Abuelela', role: 'Prev. Mkt Expansion SR mgr MODANISA / Now Director of e-commerce MENA – DeFacto', quote: '“Lancer une marque de mode modeste sur un nouveau marché comme le Maroc représentait un véritable défi, et Boxcom a su relever le défi. Leur équipe s’est rapidement approprié notre marque et a apporté à la fois créativité et compréhension culturelle au lancement. Ce qui nous a le plus impressionnés, c’est leur disponibilité constante ainsi que l’implication directe de la direction, ce qui nous a donné confiance à chaque étape. Grâce à leur engagement, Modanisa a réussi son entrée sur le marché marocain avec une présence forte et authentique.”' },
